...
public class SliderDemo {
	...
	public static void main(String[] args) {
		...
		//get only X
		//System.out.println("Defualt Location of the min slider: "+min_slider.getLocation().getX());
		//get only y
		//System.out.println("Defualt Location of the min slider: "+min_slider.getLocation().getY());
